...
void eeprom_read(uint8_t addr, client interface i2c_master_if i2c, uint8_t no_of_bytes, uint8_t data[])
{
...
void eeprom_write(uint8_t data[], uint8_t no_of_db, client interface i2c_master_if i2c)
{
    size_t no_bytes_sent;
    i2c_res_t res = 0;
    while(res == 0)
