...
void my_spiffs_mount(CLIENT_INTERFACE(FlashDataInterface, i_data))
{
    ...
    #define SPIFFS_LOG_BLOCK_SIZE   32768   //because memory is too small for 64K blocks
#else
    ...
    #define SPIFFS_LOG_BLOCK_SIZE   65536   //standart SPIFFS blocks
#endif
    ...
    cfg.log_block_size = SPIFFS_LOG_BLOCK_SIZE; // let us not complicate things
